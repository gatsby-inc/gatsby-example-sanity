...
Note: this project _requires_ yarn.
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/xq50spjj/settings/api) and create a token with read rights.
